        ...
        if (nodeConfig.settype == 1) {
            if (nodeConfig.nodeUserList.length == 1) {
                ...
                if (nodeConfig.examineMode == 1) {
                    ...
                    return this.arrToStr(nodeConfig.nodeUserList) + ' 等 ' + nodeConfig.nodeUserList.length + "人会签"
                } else if (nodeConfig.examineMode == 3) {
                    return this.arrToStr(nodeConfig.nodeUserList) + ' 等 ' + nodeConfig.nodeUserList.length + "人或签"
                }
            }
            ...
            return nodeConfig.directorLevel == 1 ? '销售' : '其他'
        }
    },
    dealStr(str, obj) {
        let arr = [];
    ...
    conditionStr(nodeConfig, index) {
        ...
        if (conditionList.length == 0) {
            ...
            if (conditionList.length == 1) {
                if (conditionList[0].expression == '') return "请设置条件"
                return conditionList[0].expression
            } else {
                return "请设置条件"
            }
