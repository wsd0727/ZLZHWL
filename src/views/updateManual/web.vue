        ...
        <el-card class="box-card">
          <template #header>
            <div class="card-header">
              <p style="text-align: center">前端更新手册</p>
            </div>
          ...
          <el-scrollbar :height="leftHight">
            <div v-for="(item, index) in options" :key="index" class="leftText">
              <p @click="leftTextClick(item.BILLNO, item.VNAME, index)" :class="{ lside: sideIndex == item.BILLNO }">
                {{ item.VNAME }}
              </p>
            </div>
          </el-scrollbar>
        ...
        <el-card class="box-card">
          ...
          <div class="card-header">
            <div class="button-item prevIcon">
              <div class="leftIcon" v-if="titleIndex > 0" @click="iconClick(titleIndex - 1)">
                <el-icon>
                  <ArrowLeftBold />
                </el-icon>
                <p>{{ prevTitle }}</p>
            ...
            <div class="button-item nextIcon">
              <div class="rightIcon" v-if="titleIndex < options.length - 1" @click="iconClick(titleIndex + 1)">
                <p>{{ nextTitle }}</p>
                <el-icon>
                  <ArrowRightBold />
                </el-icon>
          ...
          <el-scrollbar :height="Hight">
            <el-container>
              <el-main>
                <div class="rightText">
                  <div class="rightUser ">
                    <div class="textContent mce-content-body " v-html="textContent"></div>
                  </div>
                </div>
              </el-main>
...
<script setup>
const sideIndex = ref();
const Hight = window.innerHeight - 197;
const leftHight = window.innerHeight - 224;
