              ...
              <div class="group-item-flex">
                <div class="group-item" style="flex:.6">
                  <div class="group-title">
                    ...
                    <div class="types">
                      <el-radio-group v-model="TQTYPE" size="default">
                        <el-radio-button value="0" label="0">收入</el-radio-button>
                        <el-radio-button value="1" label="1">毛利润</el-radio-button>
                      </el-radio-group>
...
import { trimAll, toThousands } from "@/utils"
...
/** 日期  */
const dateTime = ref(new Date().toLocaleDateString().replaceAll("/", "-"))
...
const getJGFBTQBDATA = () => {
  getJGFB({
    DATATYPE: TQDATE.value,
    DATETYPE: TQTYPE.value,
...
const getFYDATA = () => {
  getFY({
    DATADATE: "2023-11" //dateMON.value
  }).then(res => {
