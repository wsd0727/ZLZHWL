    ...
    <div class="app-table-box">
      <div class="app-table-box-right" style="width: 100px">
        <div class="query-wrap">
          <Form class="query-form" ref="formRefTop" v-model:formData="queryParams" :formConfig="set24col(queryConfig, 6)" :inline="true" @select="formSelect" @enter="queryData" />
          ...
          <template #default>
            <ol class="pointForm">
              <li v-for="(item,index) in pointData" :key="index">
                <el-cascader v-model="item.code" checkStrictly placeholder="" size="default" :options="optionsRegion" style="width: 70%;margin-right:5px" @change="(val) => pointChange(index, val)" />
...
import { getList, getDetail, saveAdd, saveEdit, updateStatus, setDel, Config_Btn, Config_Form, Config_Query, Config_Table } from "#/JDWL/record"
