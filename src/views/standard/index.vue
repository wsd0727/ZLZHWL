      ...
      <el-col :span="4">
        <el-card class="box-card">
          <template #header>
            ...
            <el-input v-model="input3" class="w-50 m-2" size="small" placeholder="请输入关键字">
              <template #append>
          ...
          <el-scrollbar :height="leftHight">
            <div class="leftText" v-for="(item, index) in options" :key="index">
              <p @click="leftTextClick(item.BILLNO, item.TITLE, index)" :class="{ lside: sideIndex == item.BILLNO }">
                {{ item.TITLE }}
              </p>
            </div>
          </el-scrollbar>
              ...
              <el-main>
                <div class="rightText">
                  <div class="rightUser mce-content-body">
                    <div class="DescriptionStyle" v-if="Description != '' || textContent != ''">
                      <span>
                        文章简介：
                      </span>
                      <p>{{ textContent.DESCIRTP }}</p>
                    </div>
                    <div class="textContent" v-html="textContent.CONTENT"></div>
                  </div>
                </div>
              </el-main>
              <!-- <el-footer>
...
<script setup>
const sideIndex = ref();
const Hight = window.innerHeight - 196;
...
const options = ref([
  // {
  //   value: "CL230221975684",
  //   label: "WEB开发规范",
  // },
  // {
  //   value: "CL230221856255",
  //   label: "JAVA开发规范",
  // },
]);
...
function getLeftList() {
  let data = {
    ...
    SORTNAME: "",
    REVERSE: "",
    PK_CLASS: "CL230221856255",
    KEY: "",
    MODULEID: "MU230206741565",
    PAGEID: "PG230206564533",
    VERSION: "",
  };
  getGfLeftList(data).then((res) => {
...
function getRightList() {
  let data = {
    ...
    SORTNAME: "",
    REVERSE: "",
    PK_CLASS: sideIndex.value,
    BILLNO: sideIndex.value,
    KEY: "",
    MODULEID: "MU230206741565",
    PAGEID: "PG230206122597",
    VERSION: "",
  };
  getGfRightList(data).then((res) => {
    textContent.value = res.RESULT;
  });
}
