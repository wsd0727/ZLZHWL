    ...
    <div class="app-table-box">
      <div class="app-table-box-right" style="width: 100px">
        ...
        <vxe-modal destroy-on-close v-model="pageConfig.modalVisible" :width="pageConfig.modalW" :height="pageConfig.modalH" id="tableModal" resize storage transfer show-zoom show-footer @close="closeModal">
          ...
          <template #default>
            <Form ref="FormRef" :detail="formConfig.formType == 'DTL'" v-model:formData="formConfig.formValue" :formConfig="formConfig.formColumns" :rules="formConfig.formRules" :othConfig="{labelWidth:'90px'}">
...
import { getList, getDetail, saveAdd, saveEdit, updateStatus, setDel, Config_Btn, Config_Form, Config_Query, Config_Table } from "#/ZLZHWL/record"
