      ...
      <div class="group-content">
        <el-row class="content">
          ...
          <el-col :span="6" class="content-item">
            ...
            <TextOverflow :content="orderData.CARRIERNAME" class="value" />
          </el-col>
          <el-col :span="6" class="content-item">
        ...
        <template v-if="goodsList.length > 3">
          <miniTable height="186" :data="goodsList">
            ...
            <vxe-column field="name" title="委托进度" align="left" width="420">
              <template #default={row}>
                <el-progress :percentage="(row.ENTRUSTNUM / row.DTLNUM)*100" :format="()=>orderData.ASSIGNMENTUNIT != '4' ? `订单量 ${row.DTLNUM}${row.TRANSUNIT}` : ''" />
              </template>
            </vxe-column>
          </miniTable>
        </template>
            ...
            <div class="table">
              <template v-if="selectType == 'car'">
                <miniTable ref="tableRef" row-id="PK_CAR" :data="dataList" :height="miniTableHeight" show-overflow="tooltip" @change="AddPZ">
                  ...
                  <vxe-column field="VDEF4" title="挂车号" align="center" min-width="100" fixed="left"></vxe-column>
...
import { getOrderDetail, PZConfig, savePZDriver } from "#/THGT/OwnerCargo/Stowage"
