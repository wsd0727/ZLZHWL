<template>
  <div :class="{ 'has-logo': showLogo, side: true, leftNav: !topNav }">
    ...
    <div class="logo-wrap" v-if="avatarUrl">
    ...
    <el-scrollbar :class="sideTheme" wrap-class="scrollbar-wrapper">
      ...
      <template v-if="!topNav">
        <div class="menu  555" v-for="(item, index) in topMenus" :key="item.path" @click="changeMenu(item, index)">
          <div :class="[
              'menu-title',
...
if (systemConfig.value && systemConfig.value.baseUrl) {
  avatarUrl.value = systemConfig.value.logo
