...
export const Config_Form = [
  { FIELD: "BILLNO", LABEL: "编号", COL: "12", ALIGN: "left", CONTROLS: "ExTextBox", ISSHOW: "0" },
  { FIELD: "VNAME", LABEL: "名称", COL: "12", ALIGN: "left", CONTROLS: "ExTextBox", ISSHOW: "1", ISREQUIRE: "1" },
  { FIELD: "PK_AREA", LABEL: "片区", COL: "12", ALIGN: "left", CONTROLS: "ExSelectGroup", ISSHOW: "1", ISREQUIRE: "1" , OTHER:"/base/bd-area/getTreeList???AREA=LABEL" },
  { FIELD: "STARTADDRESS", LABEL: "起点", COL: "12", ALIGN: "left", CONTROLS: "ExArea", ISSHOW: "1", ISREQUIRE: "1", REVERFIELD: "STARTAREA", OTHER: "/a???STARTADDRESSName=dataName&STARTADDRESS=data" },
  ...
  { FIELD: "ENDADDRESS", LABEL: "终点", COL: "12", ALIGN: "left", CONTROLS: "ExArea", ISSHOW: "1", ISREQUIRE: "1", REVERFIELD: "ENDAREA", OTHER: "/a???ENDADDRESSName=dataName&ENDADDRESS=data" },
...
export const Config_Query = [
  { FIELD: "VNAME", LABEL: "名称", COL: "4", ALIGN: "left", CONTROLS: "ExTextBox", ISSHOW: "1", GROUPID: "1" },
  { FIELD: "STARTAREA", LABEL: "起点", COL: "4", ALIGN: "left", CONTROLS: "ExTextBox", ISSHOW: "1", GROUPID: "1" },
  { FIELD: "ENDAREA", LABEL: "终点", COL: "4", ALIGN: "left", CONTROLS: "ExTextBox", ISSHOW: "1", GROUPID: "1" },
  // { FIELD: "TJSITEINFO", LABEL: "途经点", COL: "4", ALIGN: "left", CONTROLS: "ExTextBox", ISSHOW: "1", GROUPID: "1" },
]
