...
export const Config_Form = [
  ...
  { FIELD: "INFOSERCOST", LABEL: "固定信息费", COL: "12", ALIGN: "left", CONTROLS: "ExNumber", ISSHOW: "1",ISREQUIRE: "1",SLOTCFG: '{"MIN":"0"}'},
...
export const Config_Table = [
  ...
  { FIELD: "INFOSERCOST", LABEL: "固定信息费", WIDTH: "100", ALIGN: "center", CONTROLS: "ExTextBox", VTYPE: "exNum", ISSHOW: "1", OTHER: JSON.stringify(status) },
