...
// 删除用户组织
export function delDataScope(data) {
  return request({
    url: '/sys/dataScope/deleteBatchIds',
    method: 'post',
    data: data
  })
}
...
export const FormConfig = [
  { FIELD: "PK_ORG", LABEL: "组织", COL: 12, CONTROLS: "ExSelectGroup", ISREQUIRE: 1, ISSHOW: 1, OTHER: "/sys/organize/getUserTreeList???ORGNAME=LABEL", LINKAGE: "{\"CLEAN\":\"PK_DEPT,DEPTNAME,PK_USERGROUP\"}", REVERFIELD: "ORGNAME" },
  ...
  // { FIELD: "PK_USERGROUP", LABEL: "分组", COL: 12, CONTROLS: "ExSelectSearch", ISREQUIRE: 0, ISSHOW: 1, OTHER: "/dynamic/component/getSelectTypeList?TYPE=22?PK_COMPANY=PK_ORG?USERGROUPNAME=LABEL", REVERFIELD: "USERGROUPNAME" },
  { FIELD: "PK_USERGROUP", LABEL: "分组", COL: 12, CONTROLS: "ExSelectSearch", ISREQUIRE: 0, ISSHOW: 1, OTHER: "/sys/component/getSelectTypeList?TYPE=22?PK_COMPANY=PK_ORG?USERGROUPNAME=LABEL", REVERFIELD: "USERGROUPNAME" },
  { FIELD: "USERNAME", LABEL: "账号", COL: 12, CONTROLS: "ExTextBox", ISREQUIRE: 1, ISSHOW: 1, OTHER: "", MAXLENGTH: "20" },
  { FIELD: "PASSWORD", LABEL: "密码", COL: 12, CONTROLS: "ExPassword", ISREQUIRE: 1, ISSHOW: 0, OTHER: "", MAXLENGTH: "30", RULES: 'Password', ISAES: "4", LINKAGE: '{"AESENCRYSYNC":"PID"}' },
...
export const PWDConfig = [
  ...
  { FIELD: "NEWPASSWORD", LABEL: "新密码", COL: 24, CONTROLS: "ExPassword", ISREQUIRE: 1, ISSHOW: 1, OTHER: "", RULES: 'Password', ISAES: "4", LINKAGE: '{"AESENCRYSYNC":"PID"}' },
  { FIELD: "SUREPASSWORD", LABEL: "确认密码", COL: 24, CONTROLS: "ExPassword", ISREQUIRE: 1, ISSHOW: 1, OTHER: "", RULES: 'Password', ISAES: "4", },
]
