      ...
      if (n.some(function(n2) {
        ...
        if (1 === r3.length)
          ...
          n.forEach(function(n2) {
            0 === n2.indexOf(r3) && s.push(n2);
          }), u2.push(s);
        }
        t2 = true;
      } else
        -1 !== n.indexOf(r3) && g2[h3 + 1] && (u2.push(r3), t2 = true);
      if (t2) {
        var c = o2.length;
...
function o(n2) {
  ...
  }), 0 !== a2.length && a2[0].length === n2.length || a2.push(n2.split("")), i = function(n3, a3, i2) {
