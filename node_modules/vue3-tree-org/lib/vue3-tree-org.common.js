...
// CONCATENATED MODULE: ./src/components/tree-org/src/tree.vue?vue&type=template&id=f08413b6&ts=true
    ...
    function handleUpCb(e) {
      ...
      if (typeof beforeDragEnd === 'function') {
        ...
        if (before && before.then) {
          before.then(() => {
            doDragEnd(e); // eslint-disable-next-line @typescript-eslint/no-empty-function
          }, () => {});
...
const useTree = (props, {
  ...
  function preventOutOfBounds(x, y) {
    ...
    if (props.center) {
      ...
      minX = minX - deviation;
      maxX = maxX - deviation; // console.log(props.center, minX, 38)
    }
